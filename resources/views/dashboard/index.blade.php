<x-app-layout title="Tableau de bord">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-icon" style="background:#E8F0FE;color:#1E56A0;">
            ...
            <div>
                <div class="stat-value">{{ number_format($stockValue, 0, ',', ' ') }} FCFA</div>
                <div class="stat-label">Valeur du stock</div>
                <div class="stat-subtitle">coût d'achat total</div>
            </div>
        </div>
        @endcan
