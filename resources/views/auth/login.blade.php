    ...
    <div class="login-page">
        ...
        <div class="login-decoration">
            ...
            <div class="deco-content">
                <div class="deco-logo" style="background: none; border: none; box-shadow: none; width: 100%; text-align: center; margin-bottom: 2rem;">
        <img src="{{ asset('img/logo-white.png') }}" 
             alt="Terminus-Boutique Logo" 
             style="width: 380px; height: auto; filter: drop-shadow(0px 4px 10px rgba(101, 2, 2, 0.3));">
    </div>
