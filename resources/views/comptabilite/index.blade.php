                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="small text-muted">
                            Par {{ $entry->createdBy?->name ?? 'N/A' }}
                            @if($entry->reference_type === 'App\Models\StockMovement')
                                <span class="badge bg-info ms-1">Stock</span>
                                <a href="{{ route('stock.index') }}" class="text-decoration-none ms-1" title="Voir stock">
