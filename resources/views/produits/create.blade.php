<x-app-layout title="Nouveau produit">
    <div class="modern-form-container">
        ...
        <form action="{{ route('produits.store') }}" method="POST" class="modern-form">
            @csrf
            ...
            <div class="form-section" id="section-1">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-desc">Nom et description de votre produit</p>
                    </div>
                </div>
            ...
            {{-- Section 2: Configuration des unités --}}
                ...
                <div class="config-card primary">
                    ...
                    <div class="form-field">
                        ...
                        <span class="field-hint">
                            ...
                            Tout le stock sera stocké et compté dans cette unité
                        </span>
                        ...
                        <div class="conversion-fields">
                            ...
                            <div class="form-field rate-field">
                                ...
                                <input type="number" id="sale_conversion_rate" name="sale_conversion_rate" 
                                       value="{{ old('sale_conversion_rate') }}" min="1" 
                                       class="modern-input" placeholder="Ex: 12">
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-section hidden" id="section-3">
                <div class="section-header">
                    ...
                    <div>
                        <h2>Stock initial</h2>
                        <p class="section-desc">Quantité de départ et seuil d'alerte</p>
                    </div>
                </div>
                    ...
                    <div class="stock-input-group">
                        <div class="form-field main-stock">
                            ...
                            <div class="stock-input-wrapper">
                                ...
                                <select id="initial_stock_unit" name="initial_stock_unit" 
                                        class="modern-input unit-select" onchange="updateStockPreview()">
                            ...
                            @error('initial_stock_unit')<span class="field-error">{{ $message }}</span>@enderror
                        </div>

                        <div class="form-field conversion-rate" id="stock-conversion-field" style="display:none;">
                            <label for="initial_stock_conversion_rate" class="field-label">
                                Taux de conversion <span class="required">*</span>
                            </label>
                            <div class="rate-input-wrapper">
                                <span class="rate-text">1 <span id="stock-unit-label">carton</span> =</span>
                                <input type="number" id="initial_stock_conversion_rate" name="initial_stock_conversion_rate"
                                       value="{{ old('initial_stock_conversion_rate') }}" min="1"
                                       class="modern-input rate-number" placeholder="12">
                                <span class="rate-text" id="base-unit-display">pièces</span>
                            </div>
                            @error('initial_stock_conversion_rate')<span class="field-error">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    ...
                    <div class="preview-card" id="stock-preview">
                        ...
                        <div class="preview-content">
                            <div class="preview-row">
                                <span class="preview-label">Saisie:</span>
                                <span class="preview-value" id="preview-input">0</span>
                            </div>
                            <div class="preview-arrow">↓</div>
                            <div class="preview-row highlight">
                                <span class="preview-label">Stock réel:</span>
                                <span class="preview-value" id="preview-base">0 <span id="preview-base-unit">pièces</span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-field alert-field">
                        ...
                        <div class="alert-input-wrapper">
                            <input type="number" id="alert_threshold" name="alert_threshold" 
                                   ...
                                   class="modern-input">
                            <span class="alert-unit" id="alert-unit-label">pièces</span>
                        </div>
                        <span class="field-hint">
                            <span class="hint-icon">🔔</span>
                    ...
                    <div class="form-field status-field">
                        <label class="toggle-label">
                            <input type="checkbox" name="is_active" value="1" 
                                   {{ old('is_active', true) ? 'checked' : '' }} class="modern-toggle">
...
// Update all labels when base unit changes
function updateUnitLabels() {
    const unitSelect = document.getElementById('unit');
    const baseUnit = unitSelect.value;
    const baseUnitText = unitSelect.options[unitSelect.selectedIndex].text.split(' ')[1]; // Get emoji + name
    
    // Update default unit label in stock dropdown
    document.getElementById('default-unit-label').textContent = baseUnit;
    document.getElementById('default-unit-label').textContent = baseUnit;
    
    // Update alert unit labels
    const alertLabels = document.querySelectorAll('#alert-unit-label');
    alertLabels.forEach(label => label.textContent = baseUnit + 's');
    
    // Update preview base unit
    ...
    document.getElementById('stock-unit-label').textContent = document.getElementById('initial_stock_unit').value || baseUnit;
    
    // Update initial stock unit dropdown first option
...
// Handle conversion fields visibility
function updateConversions() {
    // This function handles any dynamic behavior for conversion fields
    // Currently handled by CSS, but can be extended
}

// Calculate and display stock preview
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('current_stock').addEventListener('input', updateStockPreview);
    document.getElementById('initial_stock_unit').addEventListener('change', updateStockPreview);
    document.getElementById('initial_stock_conversion_rate').addEventListener('input', updateStockPreview);
    document.getElementById('purchase_conversion_rate').addEventListener('input', updateStockPreview);
    document.getElementById('sale_conversion_rate').addEventListener('input', updateStockPreview);
});
</script>
</x-app-layout>
