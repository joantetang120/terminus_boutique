<x-app-layout title="Nouveau produit">
                ...
                <div class="card-body">
                    <div class="field-group">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}"
                            class="styled-input" placeholder="Ex: Cahier A4 200 pages" required autofocus>
                        @error('name')
                            ...
                            <div class="select-wrapper">
                                <select id="unit" name="unit" class="styled-select" required
                                    ...
                                    <option value="piece" {{ old('unit') === 'piece' ? 'selected' : '' }}>Pièce
                                        (unité)</option>
                                    <option value="paquet" {{ old('unit') === 'paquet' ? 'selected' : '' }}>Paquet
                                    </option>
                                    <option value="boite" {{ old('unit') === 'boite' ? 'selected' : '' }}>Boîte
                                    </option>
                                    <option value="carton" {{ old('unit') === 'carton' ? 'selected' : '' }}>Carton
                                    </option>
                                    <option value="sceau" {{ old('unit') === 'sceau' ? 'selected' : '' }}>Sceau
                                    </option>
                                    <option value="sacs" {{ old('unit') === 'sacs' ? 'selected' : '' }}>Sacs
                                    </option>
                                ...
                                <div class="field-group">
                                    ...
                                    <div class="select-wrapper">
                                        <select id="purchase_unit" name="purchase_unit" class="styled-select"
                                            ...
                                            <option value="piece"
                                                {{ old('purchase_unit') === 'piece' ? 'selected' : '' }}>Pièce</option>
                                            <option value="paquet"
                                                {{ old('purchase_unit') === 'paquet' ? 'selected' : '' }}>Paquet
                                            </option>
                                            <option value="boite"
                                                {{ old('purchase_unit') === 'boite' ? 'selected' : '' }}>Boîte</option>
                                            <option value="carton"
                                                {{ old('purchase_unit') === 'carton' ? 'selected' : '' }}>Carton
                                            </option>
                                            <option value="sceau"
                                                {{ old('purchase_unit') === 'sceau' ? 'selected' : '' }}>Sceau</option>
                                            <option value="sacs"
                                                {{ old('purchase_unit') === 'sacs' ? 'selected' : '' }}>Sacs</option>
                                ...
                                <div class="field-group">
                                    ...
                                    <div class="rate-input-group">
                                        ...
                                        <input type="number" id="purchase_conversion_rate"
                                            ...
                                            value="{{ old('purchase_conversion_rate') }}" min="1"
                    ...
                    <div class="stock-input-section">
                        <div class="field-group">
                            ...
                            <div class="stock-input-wrapper">
                                <input type="number" id="current_stock" name="current_stock"
                                    value="{{ old('current_stock', 0) }}" min="0" step="1"
                                    class="styled-input stock-number-input" required oninput="updateStockPreview()">
                                <div class="stock-unit-select">
                                    <select id="initial_stock_unit" name="initial_stock_unit" class="styled-select"
                                        onchange="updateStockPreview()">
                                        <option value="">-- <span id="default-unit-label">pièce</span> (base) --
                                        </option>
                                        <option value="carton"
                                            {{ old('initial_stock_unit') === 'carton' ? 'selected' : '' }}>carton
                                        </option>
                                        <option value="boite"
                                            {{ old('initial_stock_unit') === 'boite' ? 'selected' : '' }}>boite
                                        </option>
                                        <option value="paquet"
                                            {{ old('initial_stock_unit') === 'paquet' ? 'selected' : '' }}>paquet
                                        </option>
                                        <option value="piece"
                                            {{ old('initial_stock_unit') === 'piece' ? 'selected' : '' }}>piece
                                        </option>
                                        <option value="sceau"
                                            {{ old('initial_stock_unit') === 'sceau' ? 'selected' : '' }}>sceau
                                        </option>
                                        <option value="sacs"
                        ...
                        <div class="field-group" id="stock-conversion-field" style="display:none;">
                            ...
                            <div class="rate-input-group">
                                ...
                                <input type="number" id="initial_stock_conversion_rate"
                                    name="initial_stock_conversion_rate"
                                    value="{{ old('initial_stock_conversion_rate') }}" min="1"
                                    class="styled-input rate-input" placeholder="12" oninput="updateStockPreview()">
                    ...
                    <div class="preview-card" id="stock-preview">
                        ...
                        <div class="preview-body">
                            ...
                            <div class="preview-row highlighted">
                                ...
                                <span class="preview-value large" id="preview-base">0 <span
                                        id="preview-base-unit">pièces</span></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="field-group">
                            ...
                            <div class="alert-input-group">
                                <input type="number" id="alert_threshold" name="alert_threshold"
                                    value="{{ old('alert_threshold', 0) }}" min="0" step="1"
                    ...
                    <div class="status-section">
                        <label class="toggle-wrapper">
                            <input type="checkbox" name="is_active" value="1"
                                {{ old('is_active', true) ? 'checked' : '' }} class="toggle-input">
            ...
            <div class="form-card hidden" id="step-4">
                ...
                <div class="card-body">
                                    ...
                                    <div class="price-fields">
                                        <div class="field-group">
                                            ...
                                            <input type="number"
                                                ...
                                                oninput="calculateMinimumPrice(this)" required>
                                        </div>
                                        <div class="field-group">
                    ...
                    <div class="empty-prices-message"
                        style="display: @if (old('sale_conversions')) none @else block @endif;">
    ...
    <script>
        ...
        function generatePriceFieldsFromConversions() {
            ...
            // Hide empty message (we always show base unit at least)
            if (emptyMessage) emptyMessage.style.display = 'none';

            // Clear existing price fields
            priceConversionsContainer.innerHTML = '';

            // Get old values for base unit
            const oldBasePrice = `{{ old('base_sale_price', '') }}`;
            const oldBaseMargin = `{{ old('base_sale_margin_percentage', '') }}`;

            // Add base unit price field FIRST
            const basePriceHTML = `
                <div class="price-conversion-row price-conversion-row--base" data-index="base">
                    <div class="price-conversion-header">
                        <span class="price-unit-badge price-unit-badge--base">${baseUnit} (Base)</span>
                    ...
                    <div class="price-fields">
                        ...
                        <div class="minimum-price-display">
                            <span class="minimum-price-label">Prix minimum:</span>
                            <span class="minimum-price-value" id="min-price-base">0,00 FCFA</span>
                        </div>
                    </div>
                </div>
            `;
            priceConversionsContainer.insertAdjacentHTML('beforeend', basePriceHTML);
            ...
            conversionRows.forEach((row, index) => {
                ...
                // Get existing values from old() if available
                const oldPrice = `{{ old('sale_conversions.${index}.sale_price', '') }}`;
                const oldMargin = `{{ old('sale_conversions.${index}.sale_margin_percentage', '') }}`;
        ...
        function updateUnitLabels() {
            ...
            const defaultUnitLabel = document.getElementById('default-unit-label');
            if (defaultUnitLabel) defaultUnitLabel.textContent = baseUnit;

            const alertUnitLabel = document.getElementById('alert-unit-label');
            if (alertUnitLabel) alertUnitLabel.textContent = baseUnit + 's';

            const previewBaseUnit = document.getElementById('preview-base-unit');
            if (previewBaseUnit) previewBaseUnit.textContent = baseUnit + 's';

            const baseUnitDisplay = document.getElementById('base-unit-display');
            if (baseUnitDisplay) baseUnitDisplay.textContent = baseUnit + 's';
    ...
    <style>
        ...
        .price-conversion-row--base {
            background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%);
            border-color: #3b82f6;
            border-width: 3px;
        }

        .price-conversion-row--base:hover {
            border-color: #2563eb;
